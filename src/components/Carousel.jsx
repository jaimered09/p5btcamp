            ...
            <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="public/images/iPhone-14 header copy.webp" className="d-block w-100" alt="..." width="1440" height="620" />
                    </div>
                    <div className="carousel-item">
                        <img src="public/images/carouselheader.webp" className="d-block w-100" alt="..." width="1440" height="620" />
                    </div>
                    <div className="carousel-item">
                        <img src="public/images/bannerheader iphone2- copy.webp" className="d-block w-100" alt="..." width="1440" height="620" />
                    </div>
                </div>
